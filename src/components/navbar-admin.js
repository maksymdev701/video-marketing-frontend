      ...
      <header data-thq="thq-navbar" className="navbar-admin-navbar-interactive">
        ...
        >
          ...
          >
            ...
            <Link to="/download" className="navbar-admin-navlink1">
              {props.text1}
            </Link>
            <Link to="/account" className="navbar-admin-navlink2">
              {props.text2}
            </Link>
          </nav>
          <Language rootClassName="language-root-class-name3"></Language>
        ...
        <div data-thq="thq-mobile-menu" className="navbar-admin-mobile-menu">
          ...
          >
            ...
            >
              <span className="navbar-admin-text">{props.text4}</span>
              <span className="navbar-admin-text1">{props.text5}</span>
              <span className="navbar-admin-text2">{props.text6}</span>
              <span className="navbar-admin-text3">{props.text7}</span>
              <span className="navbar-admin-text4">{props.text8}</span>
            </nav>
