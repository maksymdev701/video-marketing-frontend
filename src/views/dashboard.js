    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-red-dashboard">
        <div className="dashboard-stat">
          ...
          <h1 className="dashboard-text01 StatsBig">€12,000,000</h1>
        ...
        <div className="dashboard-stat01">
          ...
          <h1 className="dashboard-text03 StatsBig">12,000</h1>
        ...
        <div className="dashboard-stat02">
          ...
          <h1 className="dashboard-text05 StatsBig">13,000,000</h1>
        ...
        <div className="dashboard-stat03">
          ...
          <h1 className="dashboard-text07 StatsBig">43,000,000</h1>
        ...
        <div className="dashboard-stat04">
          ...
          <h1 className="dashboard-text09 StatsBig">1,000</h1>
        ...
        <div className="dashboard-stat05">
          ...
          <h1 className="dashboard-text11 StatsBig">100,000,000</h1>
        ...
        <div className="dashboard-stat06">
          ...
          <h1 className="dashboard-text13 StatsBig">130,000,000</h1>
        ...
        <div className="dashboard-stat07">
          ...
          <h1 className="dashboard-text15 StatsBig">13,000,000</h1>
      ...
      <div className="dashboard-month-stats">
        ...
        <div className="dashboard-dashboard2">
          <div className="dashboard-stat08">
            ...
            <h1 className="dashboard-text18">€2,000,000</h1>
          ...
          <div className="dashboard-stat09">
            ...
            <h1 className="dashboard-text20 StatsBig">50,000,000</h1>
          ...
          <div className="dashboard-stat10">
            ...
            <h1 className="dashboard-text22">25,000,000</h1>
          ...
          <div className="dashboard-stat11">
            ...
            <h1 className="dashboard-text24">1,300,000</h1>
      ...
      <div className="dashboard-table-body">
        <div className="dashboard-table-row">
          ...
          <div className="dashboard-container15">
            <span className="dashboard-text33">5,000,000</span>
          </div>
          <div className="dashboard-container16">
            <span className="dashboard-text34">4,000,000</span>
          </div>
          <div className="dashboard-container17">
            <span className="dashboard-text35">80%</span>
          </div>
          <div className="dashboard-container18">
            <span className="dashboard-text36">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row01">
          <div className="dashboard-container19">
            <span className="dashboard-text37">Aug</span>
          </div>
          <div className="dashboard-container20">
            <span className="dashboard-text38">5,000,000</span>
          </div>
          <div className="dashboard-container21">
            <span className="dashboard-text39">4,000,000</span>
          </div>
          <div className="dashboard-container22">
            <span className="dashboard-text40">80%</span>
          </div>
          <div className="dashboard-container23">
            <span className="dashboard-text41">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row02">
          <div className="dashboard-container24">
            <span className="dashboard-text42">Sep</span>
          </div>
          <div className="dashboard-container25">
            <span className="dashboard-text43">5,000,000</span>
          </div>
          <div className="dashboard-container26">
            <span className="dashboard-text44">4,000,000</span>
          </div>
          <div className="dashboard-container27">
            <span className="dashboard-text45">80%</span>
          </div>
          <div className="dashboard-container28">
            <span className="dashboard-text46">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row03">
          <div className="dashboard-container29">
            <span className="dashboard-text47">Oct</span>
          </div>
          <div className="dashboard-container30">
            <span className="dashboard-text48">5,000,000</span>
          </div>
          <div className="dashboard-container31">
            <span className="dashboard-text49">4,000,000</span>
          </div>
          <div className="dashboard-container32">
            <span className="dashboard-text50">80%</span>
          </div>
          <div className="dashboard-container33">
            <span className="dashboard-text51">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row04">
          <div className="dashboard-container34">
            <span className="dashboard-text52">Nov</span>
          </div>
          <div className="dashboard-container35">
            <span className="dashboard-text53">5,000,000</span>
          </div>
          <div className="dashboard-container36">
            <span className="dashboard-text54">4,000,000</span>
          </div>
          <div className="dashboard-container37">
            <span className="dashboard-text55">80%</span>
          </div>
          <div className="dashboard-container38">
            <span className="dashboard-text56">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row05">
          <div className="dashboard-container39">
            <span className="dashboard-text57">Dec</span>
          </div>
          <div className="dashboard-container40">
            <span className="dashboard-text58">5,000,000</span>
          </div>
          <div className="dashboard-container41">
            <span className="dashboard-text59">4,000,000</span>
          </div>
          <div className="dashboard-container42">
            <span className="dashboard-text60">80%</span>
          </div>
          <div className="dashboard-container43">
            <span className="dashboard-text61">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row06">
          <div className="dashboard-container44">
            <span className="dashboard-text62">Jan</span>
          </div>
          <div className="dashboard-container45">
            <span className="dashboard-text63">5,000,000</span>
          </div>
          <div className="dashboard-container46">
            <span className="dashboard-text64">4,000,000</span>
          </div>
          <div className="dashboard-container47">
            <span className="dashboard-text65">80%</span>
          </div>
          <div className="dashboard-container48">
            <span className="dashboard-text66">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row07">
          <div className="dashboard-container49">
            <span className="dashboard-text67">Feb</span>
          </div>
          <div className="dashboard-container50">
            <span className="dashboard-text68">5,000,000</span>
          </div>
          <div className="dashboard-container51">
            <span className="dashboard-text69">4,000,000</span>
          </div>
          <div className="dashboard-container52">
            <span className="dashboard-text70">80%</span>
          </div>
          <div className="dashboard-container53">
            <span className="dashboard-text71">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row08">
          <div className="dashboard-container54">
            <span className="dashboard-text72">Mar</span>
          </div>
          <div className="dashboard-container55">
            <span className="dashboard-text73">5,000,000</span>
          </div>
          <div className="dashboard-container56">
            <span className="dashboard-text74">4,000,000</span>
          </div>
          <div className="dashboard-container57">
            <span className="dashboard-text75">80%</span>
          </div>
          <div className="dashboard-container58">
            <span className="dashboard-text76">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row09">
          <div className="dashboard-container59">
            <span className="dashboard-text77">Apr</span>
          </div>
          <div className="dashboard-container60">
            <span className="dashboard-text78">5,000,000</span>
          </div>
          <div className="dashboard-container61">
            <span className="dashboard-text79">4,000,000</span>
          </div>
          <div className="dashboard-container62">
            <span className="dashboard-text80">80%</span>
          </div>
          <div className="dashboard-container63">
            <span className="dashboard-text81">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row10">
          <div className="dashboard-container64">
            <span className="dashboard-text82">May</span>
          </div>
          <div className="dashboard-container65">
            <span className="dashboard-text83">5,000,000</span>
          </div>
          <div className="dashboard-container66">
            <span className="dashboard-text84">4,000,000</span>
          </div>
          <div className="dashboard-container67">
            <span className="dashboard-text85">80%</span>
          </div>
          <div className="dashboard-container68">
            <span className="dashboard-text86">10,000</span>
          </div>
        </div>
        <div className="dashboard-table-row11">
          <div className="dashboard-container69">
            <span className="dashboard-text87">Jun</span>
          </div>
          <div className="dashboard-container70">
            <span className="dashboard-text88">5,000,000</span>
          </div>
          <div className="dashboard-container71">
            <span className="dashboard-text89">4,000,000</span>
          </div>
          <div className="dashboard-container72">
            <span className="dashboard-text90">80%</span>
          </div>
          <div className="dashboard-container73">
            <span className="dashboard-text91">10,000</span>
          </div>
        </div>
      </div>
